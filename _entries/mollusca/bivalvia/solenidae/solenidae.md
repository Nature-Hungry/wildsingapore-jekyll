...
galleries:
  gallery1:
    - url: "http://www.wildsingapore.com/photos/bullet.gif"
      caption: "if you learn only 3 things about them ... On one end is the long siphon, and the other a strong muscular foot. The thin flexible shell allows it to slip easily into the sand. They are rapid burrowers. Let's put this one down and see how fast it can burrow."
    - url: "http://www.wildsingapore.com/photos/bullet.gif"
      caption: "On one end is the long siphon, and the other a strong muscular foot. The thin flexible shell allows it to slip easily into the sand. They are rapid burrowers. Let's put this one down and see how fast it can burrow."
  gallery2:
...
- [Photos](https://www.flickr.com/search/?user_id=54527470%40N00&sort=date-posted-desc&view_all=1&text=Solenidae)
for free download
- [Map of sightings in Singapore](https://www.flickr.com/photos/wildsingapore/tags/Solenidae/map?&fLat=1.2633&fLon=103.8661&zl=11&order_by=recent)
