...
[photo of the harpoon](http://shells.tricity.wsu.edu/ArcherdShellCollection/Illustrations/Cone_Lethal_Weapon.html)
...
The best recourse is to bring the victim to hospital
**immediately**
.
...
*From
[Conidae on MedScape Reference](http://emedicine.medscape.com/article/769638-overview)*

**
**How to stay safe:**
Do not handle any snails that appear conical. If you are not sure what the snail is, don't handle it. Do not collect snails in open bags or plastic bags which harpoons can penetrate to hit bare skin. Use hard containers when collecting specimens (which in Singapore should only be done with a valid permit). Do not dig into sand with bare hands. Cover all skin near the ground by wearing covered shoes and long pants.
...
- [Photos](https://www.flickr.com/search/?user_id=54527470@N00&sort=date-posted-desc&view_all=1&text=Conidae)
for free download
...
*Cyrene Reef, Aug 2013*

shared by Heng Pei Yan on
[her blog](http://peiyansama.blogspot.sg/2013/08/new-surprises-at-cyrene-reef-with-large.html)
.
...
^from
[WORM](http://www.marinespecies.org/)
