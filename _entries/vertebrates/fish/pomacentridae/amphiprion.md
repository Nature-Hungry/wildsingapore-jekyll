---
title: Anemonefishes
description: Fact sheet of Anemonefishes on the shores of Singapore
...
{% include img-wrap-group.html items=page.galleries.gallery2 %}**How do they stay alive in a sea anemone?**
...
**What do they eat?**
Anemonefishes eat mainly plankton. Some also graze algae from the surface or gathered from the water.

{% include img-wrap-group.html items=page.galleries.gallery3 %}**Amazing gender switch:**
...
**How does the baby fish find an anemone host?**
Each species of anemonefish lives in a specific species of sea anemone. Some species apparently follow chemicals released by the suitable host anemone, others find one by sight, for yet others, it is apparently simply by chance.
