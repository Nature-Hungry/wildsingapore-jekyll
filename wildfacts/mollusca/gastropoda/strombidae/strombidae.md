...
![](../../../photos/bullet.gif) Many are edible.
...
served at hawker centres. The [Black-lipped conch](urceus.htm) and [Spider conch](lambis.htm) were also eaten. The larger
Spider conch is also collected and killed for its beautifully shaped
and coloured shell.  
  
**Status and threats:** The [Black-lipped
conch](urceus.htm) and [Spider conch](lambis.htm) are listed as
'Vulnerable' on the Red List of threatened animals of Singapore, while
the [Dark Diana conch](aratrum.htm) is listed as 'Critically endangered'.
...
**Family
Strombidae recorded for Singapore**from
...
 
*[^Canarium
urceus](urceus.htm)=Strombus urceus* (Black-lipped conch)(VU: Vulnerable) *+Canarium erythrinum* *^Dolomena dilatata**=**Strombus dilatatus* *^Dolomena variabilis=Strombus variabilis* *[^Euprotomus aratrum](aratrum.htm)=Strombus
aratrum* (Dark Diana conch)(CR:
Critically endangered) *^Labiostrombus epidromis=Strombus epidromis  
  
Lambis chiragra=^Harpago chiragra  
[Lambis lambis](lambis.htm)*(Spider conch) (VU: Vulnerable) *[Strombus marginatus robustus](marginatus.htm)*
(Margined conch) *[Strombus turturella](canarium.htm)* (Gong gong)=*Strombus
canarium  
Strombus vittatus apicatus=[Doxander vittatus apicatus](vittatus.htm)* (Vitate conch) *Tibia fusus* (^now in Family Rostellariidae)
...
- [Family
  ...
  Singapore. 160 pp.
- [Family
  Strombidae](http://shells.tricity.wsu.edu/ArcherdShellCollection/Gastropoda/Strombidae.html) on The Gladys Archerd Shell Collection at Washington
...
- [Pearls
  of snail: breakthrough in snail pearl culturing](http://wildshores.blogspot.com/2009/11/pearls-of-snail-breakthrough-in-snail.html) on the wild
