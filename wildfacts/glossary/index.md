...
soft corals](../cnidaria/coralsoft/alcyoniidae), these are polyps with long stalks and tiny branched
[tentacles](#tentacle) that emerge from the shared tissue.
See also siphonozooid polyps.   
  
**Axial corallite:** In branching [acropora
corals](../cnidaria/coralhard/acroporidae/acropora), it is the large corallite at the tip of the branch. See
also radial corallite.  
  
**Blade:** the leaf-like portion of a seaweed. **Bilateral symmetry:** Symmetrical in two halves. Humans are bilaterally
...
along five axes.](#s) **Bivalves:** Animals from the Phylum [Mollusca](../mollusca/mollusca),
Class [Bivalvia](../mollusca/bivalvia). They usually
have a hinged two-part shell. Examples include [mussels](../mollusca/bivalvia/mytilidae/mytilidae),
[clams](../mollusca/bivalvia/veneridae/veneridae) and
[oysters](../mollusca/bivalvia/ostreidae/osteridae).
  
  
**Bryozoans:** Animals from the Phylum [Bryozoa](../bryozoa/bryozoan).  
  
**Byssus threads** (sometimes spelt byssal): Tough, adhesive fibres
produced by [bivalves](../mollusca/bivalvia) to attach
themselves to a firm surface. A gland in the foot produces these fibres.
Examples of animals that produce byssus threads include [mussels](../mollusca/bivalvia/mytilidae/mytilidae)
and [Fan shells](../mollusca/bivalvia/pinnidae/pinnidae).  
...
**Capsule, egg:** see [egg capsule](#e)  
  
**Carnivore:** An animal that eats the flesh of other animals.
  
 **Case, egg:** see [egg capsule](#e)  
  
**Cerata:** In some [sea slugs](../mollusca/slug)
and [nudibranchs](../mollusca/nudibranchia), these
are the many projections on the body, often finger-like, but sometimes
also leafy such as in the [Bushy
sap-sucking slug](../mollusca/slugs/sacoglossa/polybranchia).  
  
**Chlorophyll:** See [photosynthesis](#photo).  
...
**Cirri:** In [feather
stars](../echinodermata/crinoidea/crinoidea), it is the claw-like appendage on the underside that the
...
Animals from the Phylum [Cnidaria](../cnidaria/cnidaria).
...
**Colonial animals:** In [cnidarians](../cnidaria/cnidaria),
[ascidians](../ascidiacea/ascidiacea) and [bryozoans](../bryozoa/bryozoan),
...
include [hard corals](../cnidaria/coralhard/coralhard)
and [sea
pens](../cnidaria/others/pennatulacea/pennatulacea). See also [polyp](#polyp) and [zooid](#z).  
  
**Corallite:** The skeleton produced by a single [polyp](#polyp)
of a [hard coral](../cnidaria/coralhard/coralhard).  
...
details](../concepts/feeding).  
  
**Detritus:** Dung and decaying matter. A detritivore is an animal
that eats detritus. For [more details](../concepts/feeding)
on detritus.  
  
**Dorsal fin:** See [fins of a fish](#fishfin).  
  
**Echinoderms**: (Pronounced 'ee-kai-no-derms'.)
Animals from the Phylum [Echinodermata](../echinodermata/echinodermata).
...
[cephalopods](../mollusca/cephalopoda/cepeggs), [Spiral
melongena](../mollusca/gastropoda/melogenidae/cochlidium). Some animals lay their eggs in a mass or strings, coils
and ribbons.   
  
**Encrusting animals:** Animals that grow as a thin, spreading
crust or layer over hard surfaces such as rocks and shells. [Barnacles](../crustacea/othercrust/ciriipedia/cirripedia)
are an example.  
 **Endangered:** see [threatened](#t)  
  
**Exoskeleton:** See [arthropods](#arthro).  
  
**Family:** See [about
scientific names](../concepts/names).   
...
energy first created by a living thing that makes food through [photosynthesis](#photo).  
  
**Free-swimming larvae:** See [metamorphosis](#metamorf).  
  
**Gastropods**: Animals from the Phylum [Mollusca](../mollusca/mollusca),
Class [Gastropoda](../mollusca/gastropoda). They generally
creep on a muscular foot. Many have a spiralled shell. Some gastropods
such as [slugs](../mollusca/slug), however, lack shells.  
...
**Holdfast:** the part of a [seaweed](../plants/seaweed/seaweed)
...
is the intertidal zone special?](../concepts/intertidal); [More
about tides](../concepts/tides)  
...
**Larva:** See [metamorphosis](#metamorf).  
  
**Lateral line:** In many [fishes](../vertebrates/fish/fish),
...
**Mantle:** In [molluscs](../mollusca/mollusca),
it is a a thin, specialised tissue of the body that produces the shell.  
  
**Mantle skirt:** In [nudibranchs](../mollusca/nudibranchia),
this refers to the thinner edges of the body.  
  
**Mass, egg:** see [egg capsule](#e)  
  
**Medusa:** In [cnidarians](../cnidaria/cnidaria),
a medusa is an animal with a jellyfish-like shape: an umbrella-shaped
body with the mouth facing downwards and surrounded by [tentacles](#tentacle).
...
example of metamorphosis](../crustacea/othercrust/shrimp/shrimp) in shrimps. Here are some examples of
[the typical larvae](../concepts/feeding) of some common
marine animals. **Molluscs:**
Animals from the Phylum [Mollusca](../mollusca/mollusca).
They are soft-bodied and many have a [radula](#r). Many,
...
this happens in a crab](../crustacea/moulting).  
...
**Opistobranchia**: a subclass of the Class [Gastropoda](../mollusca/gastropoda).
Most opistobranchs are slug-like with a reduced shell or no
shell at all. They include [sea
hares](../mollusca/slugs/anaspidae/anaspidea), [onch
slugs](../mollusca/slugs/onchididae/onchididae) and nudibranchs.  
  
**Oral disk:** In [cnidarians](../cnidaria/cnidaria)
such as [sea
anemones](../cnidaria/actiniaria/actiniaria), this is the flat circular portion of the animal
with an opening in the centre that functions as a mouth. The
oral disk usually also bears [tentacles](#tentacle)
around the 'mouth'.  
  
**Oral tentacles:** In [sea
hares](../mollusca/slugs/anaspidae/anaspidea) and some [nudibranchs](../mollusca/nudibranchia),
these are the pair of [tentacles](#tentacle) near
the mouth. See also rhinophores.  
  
**Oral veil:** In some [nudibranchs](../mollusca/nudibranchia)
such as [armina](../mollusca/slugs/nudibranchia/babai),
this is the shield shaped structure in front of the mouth.   
  
**Order:** See [about scientific
names](../concepts/names).   
  
**Osphradium:** In [gastropods](../mollusca/gastropoda),
a sensory patch near the front of the animal that helps it sense
its surroundings.  
  
**Ossicles:** In [echinoderms](../echinodermata/echinodermata),
 ...
 **Papulae:** in [echinoderms](../echinodermata/echinodermata),
these are tiny transparent finger-like structures that appear on the
upperside of a [sea
star](../echinodermata/asteroidea/asteroidea). **Parapodia:** In [sea
hares](../mollusca/slugs/anaspidae/anaspidea) and [sacoglossans](../mollusca/slugs/sacoglossa/sacoglossa),
this is a pair of 'wings' or flaps that cover the centre part of the
body. **Pectoral fin:** See [fins of a fish](#fishfin).  
  
**Pedal disk:** In [cnidarians](../cnidaria/cnidaria)
such as [sea anemones](../cnidaria/actiniaria/actiniaria),
...
**Pedicellariae:** In some [echinoderms](../echinodermata/echinodermata)
such as [sea stars](../echinodermata/asteroidea/asteroidea)
and [sea urchins](../echinodermata/echinoidea/urchin/urchin)
and [sand
dollars](../echinodermata/echinoidea/sandollar/sandollar), these are tiny pincer-like structures found all over
the body. They are used to keep the body clear of parasites, encrusting
organisms and debris.   
  
**Periostracum:** fine hairs growing on the shell of [bivalves](../mollusca/bivalvia)
or marine snails ([gastropods](../mollusca/gastropoda)).  
  
**Petaloid:** In some [echinoderms](../echinodermata/echinodermata)
such as [sand
dollars](../echinodermata/echinoidea/sandollar/sandollar), [sea
urchins](../echinodermata/echinoidea/urchin/urchin) and [heart
urchins](../echinodermata/echinoidea/hearturchin/hearturchin), this is the petal-shaped pattern on the upper side of
the skeleton. The pattern is made up of a series of tiny holes in
the skeleton. Tube feet emerge through these holes.   
  
**Pelvic fin:** See [fins of a fish](#fishfin).  
  
**Pharynx:** in [flatworms](../worm/polycladida/polycladida),
...
**Phytoplankton:** See [plankton](#plankton)  
  
**Pinnules:** In [feather
stars](../echinodermata/crinoidea/crinoidea), these are tiny finger-like structures that arise in rows
along the arms and which give the animal its feathery look  
  
**Plankton:** Microscopic plants and animals
that drift in the sea, [some examples](../concepts/feeding).
...
poisonous organisms are [venomous](#venom). For example,
you are unlikely to die if a pufferfish bites you, but you may if
you eat it.  
  
**Polyp:** In [cnidarians](../cnidaria/cnidaria),
a polyp is an animal with a cylindrical body which is attached at
one end. The other end has a central mouth surrounded by [tentacles](#tentacle).
...
an object. The [seahorse](../vertebrates/fish/syngnathidae/hippocampus),
...
[gastropods](../mollusca/gastropoda), this is an extendible
tube which contains the radula, mouth and gullet.  
  
**Prosobranchia:** a subclass of the Class [Gastropoda](../mollusca/gastropoda).
Most prosobranchs are snails with well developed shells and breathe
through gills.  
  
**Pseudotentacles:** in a [flatworm](../worm/polycladida/polycladida),
...
[tentacles](#tentacle) like those of a snail.  
  
**Pulmonata**:
a subclass of the Class [Gastropoda](../mollusca/gastropoda).
...
corallites:**** In
branching [acropora
corals](../cnidaria/coralhard/acroporidae/acropora), these are the corallites that emerge around the
sides of a branch. See also axial corallite. **Radula:**
A tongue unique to [molluscs](../mollusca/mollusca).
...
**Rhinophores:** In [sea
hares](../mollusca/slugs/anaspidae/anaspidea) and [nudibranchs](../mollusca/nudibranchia),
these are [tentacles](#tentacle) found on top of
...
on the [bivalve](../mollusca/bivalvia) fact sheet.
...
**Septa:** In hard corals, the skeleton walls within a [corallite](#c),
the skeleton formed by one [polyp](#polyp).   

**How
a grazing snail uses its radula   
like a file to scrape off food**

**![](glossary/radula1.gif)**

*The
radula is retracted   
when the snail is not eating.*

***![](glossary/radula2.gif)***
...
siphon to get rid of wastes. Animals with a siphon include [gastropods](../mollusca/gastropoda).
...
soft corals](../cnidaria/coralsoft/alcyoniidae), these are polyps that don't emerge from the shared
tissue and function as water pumps for the colony. See also autozooid
polyps.  
  
**Slugs:** See [slugs](../mollusca/slug).  
  
**Species:** See [about scientific
names](../concepts/names).  
  
**Spicules:** see [sclerites](#s)  
  
**Sponges:** Animals from the Phylum [Porifera](../porifera/porifera).
  
  
**Stinging cells:** In cnidarians, these are special cells used
to gather food or for protection. See [cnidarians](../cnidaria/cnidaria)
for more about them and diagrams of how the stinging cells work.
  
  
**Stipe:** the stem-like portion of a [seaweed](../plants/seaweed/seaweed).  
...
details](../concepts/symbiosis).  
  
**Symmetrical along five axes:** An animal that has this feature,
such as a sea star, has a body made up of five equal parts. All [echinoderms](../echinodermata/echinodermata)
have this feature. Here are some [diagrams](../echinodermata/echinodermata1)
...
Compare with [antennae](#antennae) and [pseudotentacles](#pseudotentacle)
and [rhinophores](#r).  
  
**Test:** In some [echinoderms](../echinodermata/echinodermata)
such as [sand
dollars](../echinodermata/echinoidea/sandollar/sandollar), [sea
urchins](../echinodermata/echinoidea/urchin/urchin) and [heart
urchins](../echinodermata/echinoidea/hearturchin/hearturchin), this is their internal skeleton. The test is made of
...
**Tide, Red:** see [Red Tide](#r)  
  
**Torsion:** A developmental stage in [gastropods](../mollusca/gastropoda).  
  
**Toxin:** A substance produced by a living thing that can harm
or kill other living things. See also [poisonous](#poison)
and [venomous](#venom).  
  
**Tube feet:** In [echinoderms](../echinodermata/echinodermata),
...
**Tunic:** In [ascidians](../ascidiacea/ascidiacea),
...
or stinging. Not all venomous animals are [poisonous](#poison).
For example, you may safely eat a venomous animal like a stingray.  
  
**Verrucae:** Small spots or bumps on a [sea
anemone](../cnidaria/actiniaria/actiniaria)'s body column and underside of the oral disk. Some may
...
**Water vascular system:** In [echinoderms](../echinodermata/echinodermata),
...
about symbiosis](../concepts/symbiosis).  
  
**Zooid:** A colonial [ascidian](../ascidiacea/ascidiacea)
or [bryozoan](../bryozoa/bryozoan) is made up of tiny
...
**Zooplankton:** see [plankton](#plankton).
