---
title: "Photo index of Sand dollars"
description: ""
label: "Sand dollars"
...
{% assign target = "Cake sand dollar, Pink sand dollar, Keyhole sand dollar, Thick-edged sand dollar" | split: ", " %}

{% assign filtered_posts = site.entries | where_exp: "item", "target contains item.title" %}
<p>
