---
title: "Sea slugs with external shell"
description: ""
...
{% if post.hideFromPhotoindex != true and post.attributes contains 105 %}
...
{% include entry-summary-card.html item=entry %}
{% assign entry = site.entries | where : "title","Chitons" | first %}
{% include entry-summary-card.html item=entry %}
</div>