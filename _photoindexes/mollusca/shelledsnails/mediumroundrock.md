...
2cm - 5cm with round or conical shells on and under rocks
...
{% if match_found and post.hideFromPhotoindex != true and post.attributes contains 23 and post.attributes contains 100 %}
