---
title: "Creeper snails (Cerithiidae) on Singapore shores"
...
snails](../potamididae/potamididae.htm) (Family Potamididae) which also have an operculum made
...
**Family
Cerithiidae recorded for Singapore**from
...
plants and animals of Singapore.*+Other additions (Singapore Biodiversity Records, etc)
 
**Creeper
snails commonly seen awaiting identification***Species are difficult to positively identify without
close examination.  
On this website, they are grouped by external features for convenience
of display.*
 
[Plain creeper snail](plain.htm)   
[Variegated creeper snail](variegated.htm)
...
creeper) (EN: Endangered) *Cerithium zonatum   
  
+Cerithiopsis sykesii  
...
[Clypeomorus pellucida](pellucida.htm)* (Mangrove
...
[Rhinoclavis sinensis](obelisk.htm)* (Obelisk
creeper snail) *Rhinoclavis vertagus  
...
- [Traill's
  cerith (*Cerithium trailli*)](https://florafaunaweb.nparks.gov.sg/Special-Pages/animal-detail.aspx?id=189) on the NParks Flora and
  Fauna website.
- [Family
  Cerithiidae](http://shells.tricity.wsu.edu/ArcherdShellCollection/Gastropoda/Cerithiidae.html) on
  The
