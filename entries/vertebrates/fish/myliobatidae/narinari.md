...
which include the Manta rays! According to [FishBase](http://www.fishbase.org/summary/FamilySummary.php?ID=22):
...
item. It is commonly caught in trawl nets and gillnets. **Status and threats:** Although the Eagle ray is not listed
...
- [Photos](https://www.flickr.com/search/?user_id=54527470@N00&sort=date-taken-desc&text=Aetobatus mula&view_all=1) for free
  download
...
**Family
Myliobatidae recorded for Singapore**from
...
Myliobatidae**
 
*Aetobatus mula=Aetobatus
narinari* (White-sppotted eagle ray) *Aetomylaeus nichofii* (Banded eagle ray) *Myliobatus maculatus=\*\*Aetomylaeus maculatus* (Mottled eagle
ray)  
